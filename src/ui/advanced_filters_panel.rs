            ...
            .show(ui, |ui| {
                        ...
                        .show(ui, |ui| {
                            ...
                            .enumerate()
                            {
                                ...
                                let btn = ui.selectable_label(
                                    enabled,
                                    RichText::new(level.as_str()).color(color).size(13.0),
                                );
                ...
                ui.group(|ui| {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        ui.radio_value(&mut self.new_pattern_type, PatternType::Text, t::text());
                        ui.radio_value(&mut self.new_pattern_type, PatternType::Regex, t::regex());
                    });
                    ...
                    if self.new_pattern_type == PatternType::Regex {
                        ui.label(RichText::new(t::regex_help()).weak().small().italics());
                    }
                });
                ...
                if ui
                    .button(
                        RichText::new(t::clear_all_filters()).color(Color32::from_rgb(244, 67, 54)),
                    )
                    .clicked()
                {
                    filter.enable_all_levels();
